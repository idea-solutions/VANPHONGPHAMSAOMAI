...
namespace VANPHONGPHAM
{
    public partial class frmKetNoiDB : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void btnKiemtra_Click(object sender, EventArgs e){
            ...
            try{
                con.Open();
                MessageBox.Show("Kết nối tồn tại", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            catch{
        ...
        private void btnLuu_Click(object sender, EventArgs e){
            ...
            cn.SaveFile();
            DialogResult dialogResult =  MessageBox.Show("Kết nối thành công", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
